<!-- FABRIC TEMPLATE -->
Analyseer deze Fabric (.py) Notebook en schrijf in Markdown documentatie voor onze Azure DevOps Wiki omgeving:

1. De opgeleverde dim of fact in twee tabellen;
    - Functioneel (Voor de BI experts)
    - Technisch (Voor de Data Engineers)
    - Mermaid UML (Functionele data flow met Fabric-specifieke lagen)
...
## 🏗️ Fabric Architectuur Context
{Beschrijf de positie in de medallion architectuur: Bronze/Silver/Gold layer}
{Beschrijf de relatie met OneLake en Fabric workspace}
...
Deze documentatie is automatisch gegenereerd op basis van de Fabric notebooklogica en dient als startpunt voor review door Data Engineering en BI. Eventuele aanvullingen, correcties of optimalisaties kunnen direct in deze Wiki worden doorgevoerd.

<p align="center">
🚀 <em>Samen zorgen we voor consistente, uitlegbare en onderhoudbare data-producten in Microsoft Fabric.</em>
</p>