...
Analyseer deze Data Factory (.json) Notebook en schrijf in Markdown documentatie voor onze Azure DevOps Wiki omgeving:

1. De opgeleverde dim of fact in twee tabellen;
    - Functioneel (Voor de BI experts)
    - Technisch (Voor de Data Engineers)
    - Mermaid UML (Functionele data flow met Data Factory-specifieke lagen)
...
| **Platform**               | Microsoft Data Factory  |
| **Datum aanmaak document** | {Huidige datum en tijd} |

---

# 📚 Functionele Notebook omschrijving
{beschrijf hier duidelijk op een functionele manier wat deze Notebook doet, met specifieke aandacht voor Data Factory Lakehouse architectuur en medallion layers}

---

## 🏗️ Data Factory Architectuur Context
{Beschrijf de positie in de medallion architectuur: Bronze/Silver/Gold layer}
{Beschrijf de relatie met OneLake en Data Factory workspace}
...
Deze documentatie is automatisch gegenereerd op basis van de Data Factory notebooklogica en dient als startpunt voor review door Data Engineering en BI. Eventuele aanvullingen, correcties of optimalisaties kunnen direct in deze Wiki worden doorgevoerd.

<p align="center">
🚀 <em>Samen zorgen we voor consistente, uitlegbare en onderhoudbare data-producten in Azure Data Factory.</em>
</p>