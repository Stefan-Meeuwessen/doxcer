<!-- Pipeline TEMPLATE -->
Analyseer deze Pipeline en schrijf in Markdown documentatie voor onze Azure DevOps Wiki omgeving:

1. De opgeleverde dim of fact in twee tabellen;
    - Functioneel (Voor de BI experts)
    - Technisch (Voor de Data Engineers)
    - Mermaid UML (Functionele data flow met Pipeline-specifieke lagen)
...
| **Platform**               | {Fabric/ Synapse/ AWS/ Data Factory} Pipeline        |
| **Datum aanmaak document** | {Huidige datum en tijd} |

---

# 📚 Functionele Pipeline omschrijving
{beschrijf hier duidelijk op een functionele manier wat deze code doet, met specifieke aandacht voor Pipeline Lakehouse architectuur en medallion layers}

---

## 🏗️ Pipeline Architectuur Context
{Beschrijf de positie in de medallion architectuur: Bronze/Silver/Gold layer}
{Beschrijf de relatie met OneLake en Pipeline workspace}
...
Deze documentatie is automatisch gegenereerd op basis van de Pipeline notebooklogica en dient als startpunt voor review door Data Engineering en BI. Eventuele aanvullingen, correcties of optimalisaties kunnen direct in deze Wiki worden doorgevoerd.

<p align="center">
🚀 <em>Samen zorgen we voor consistente, uitlegbare en onderhoudbare data-logica in Pipelines.</em>
</p>