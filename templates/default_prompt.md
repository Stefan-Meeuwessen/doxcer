<!-- COMMENT -->
Analyzeer deze code en schrijf in Markdown documentatie voor onze Azure DevOps Wiki omgeving:

1. De opgeleverde dim of fact in twee tabellen;
    - Functioneel (Voor de BI experts)
    - Technisch (Voor de Data Engineers)
    - Mermaid UML (Functionele data flow)
...
{beschrijf hier duidelijk op een functionele manier wat deze code doet}
